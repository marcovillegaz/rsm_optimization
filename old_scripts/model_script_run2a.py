...
def main(data_path, effects, response, result_path, del_coeff=[]):
    ...
    # raw_data = raw_data.drop(18)  # Delete RSM_15 repeated points
    raw_data = raw_data.reset_index(drop=True)  # Reset index
    ############################################################################
...
main(
    ...
    response=["Recovery"],
    result_path=r"Result_REC - run2_exp_a",
    del_coeff=[
        "b0",
        # "b1",
        # "b2",
...
main(
    ...
    result_path=r"Result_EF - run2_exp_a",
    del_coeff=[
        "b0",
        # "b1",
        # "b2",
...
main(
    ...
    effects=effects_list,
    response=["Recovery"],
    result_path=r"Result_REC - run2_theo_a",
    del_coeff=[
        "b0",
        # "b1",
        # "b2",
...
main(
    ...
    effects=effects_list,
    response=["Enrichment factor"],
    result_path=r"Result_EF - run2_theo_a",
    del_coeff=[
        "b0",
        # "b1",
        # "b2",
