"""This scripts compute the optimum response for EF_model_simplified
and then create a surface plot with the experimetnal points"""
...
model_coefficients = import_coeff(
    r"rsm_results_simplified\Enrichment Factor_model_params.csv"
)
